...
<div id="fl-blocks-form" class="fl-settings-form">
	<h3 class="fl-settings-form-header"><?php _e( 'Enabled Blocks', 'satori-studio' ); ?></h3>
	...
	<form id="blocks-form" action="<?php FLBuilderAdminSettings::render_form_action( 'blocks' ); ?>" method="post">
		...
		<div class="fl-settings-form-content">
			...
			<p><?php _e( 'Check or uncheck modules to enable or disable them in the block editor.', 'satori-studio' ); ?></p>
			...
			<label>
				...
				<?php _ex( 'All', 'Plugin setup page: Blocks.', 'satori-studio' ); ?>
			</label>
		...
		<p class="submit">
			<input type="submit" name="update" class="button-primary" value="<?php esc_attr_e( 'Save Block Settings', 'satori-studio' ); ?>" />
