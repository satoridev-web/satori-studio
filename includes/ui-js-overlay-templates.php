<script type="text/html" id="tmpl-fl-row-overlay">
	<div class="fl-row-overlay fl-block-overlay<# if ( data.global ) { #> fl-block-overlay-global<# } #>">
		<div class="fl-block-overlay-header">
			<div class="fl-block-overlay-actions">
				<# if ( data.global && ! FLBuilderConfig.userCanEditGlobalTemplates ) { #>
					<i class="fas fa-lock fl-tip" title="<?php _e( 'Locked', 'satori-studio' ); ?>"></i>
				<# } else { #>
					...
					<# if ( 'row' !== FLBuilderConfig.userTemplateType && ! FLBuilderConfig.simpleUi ) { #>
						<span class="fl-builder-has-submenu fl-builder-submenu-hover">
							<span class="fl-block-move fl-tip" title="<?php _e( 'Move', 'satori-studio' ); ?>">
							...
							<ul class="fl-builder-submenu fl-block-move-menu">
								...
								<li>
									<a class="fl-builder-submenu-link fl-block-move-dir fl-block-move-down<# if ( data.isLast ) { #> fl-builder-submenu-disabled<# } #>" href="javascript:void(0);">
										<?php _e( 'Move Down', 'satori-studio' ); ?>
									</a>
								</li>
							</ul>
						</span>
					...
					<span class="fl-builder-has-submenu fl-builder-submenu-hover">
						<span class="fl-block-settings fl-tip" title="<?php _e( 'Row Settings', 'satori-studio' ); ?><# if ( data.nodeLabel && ! FLBuilderConfig.node_labels_disabled ) { #>{{FLBuilderConfig.node_labels_separator}}{{data.nodeLabel}}<# } #>">
						...
						<?php if ( ! $simple_ui ) : ?>
							<# if ( ! data.global || ( data.global && 'row' == FLBuilderConfig.userTemplateType ) ) { #>
								<ul class="fl-builder-submenu">
									<li><a class="fl-builder-submenu-link fl-block-settings" href="javascript:void(0);"><?php _e( 'Row Settings', 'satori-studio' ); ?></a></li>
									<li><a class="fl-builder-submenu-link fl-block-col-reset" href="javascript:void(0);"><?php _e( 'Reset Column Widths', 'satori-studio' ); ?></a></li>
									<li><a class="fl-builder-submenu-link fl-block-row-reset" href="javascript:void(0);"><?php _e( 'Reset Row Width', 'satori-studio' ); ?></a></li>
									<li><a class="fl-builder-submenu-link fl-row-quick-copy" href="javascript:void(0);"><?php _e( 'Copy Row Settings', 'satori-studio' ); ?></a></li>
									<li><a class="fl-builder-submenu-link fl-row-quick-paste <# if ( 'row' === FLBuilderSettingsCopyPaste._getClipboardType() ) { #>fl-quick-paste-active<# } #>" href="javascript:void(0);"><?php _e( 'Paste Row Settings', 'satori-studio' ); ?></a></li>
								</ul>
							<# } #>
						<?php endif; ?>
					</span>
					...
					<?php if ( ! FLBuilderModel::is_post_user_template( 'row' ) && ! $simple_ui ) : ?>
						<span class="fl-block-copy fl-tip" title="<?php _e( 'Duplicate', 'satori-studio' ); ?>">
							<svg width="18" height="18" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
								<path fill="currentColor" d="M64 464H288c8.8 0 16-7.2 16-16V384h48v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V224c0-35.3 28.7-64 64-64h64v48H64c-8.8 0-16 7.2-16 16V448c0 8.8 7.2 16 16 16zM224 304H448c8.8 0 16-7.2 16-16V64c0-8.8-7.2-16-16-16H224c-8.8 0-16 7.2-16 16V288c0 8.8 7.2 16 16 16zm-64-16V64c0-35.3 28.7-64 64-64H448c35.3 0 64 28.7 64 64V288c0 35.3-28.7 64-64 64H224c-35.3 0-64-28.7-64-64z"/>
							</svg>
						</span>
						<span class="fl-block-remove fl-tip" title="<?php _e( 'Remove', 'satori-studio' ); ?>">
		...
		<# if ( data.hasRules ) { #>
			<i class="fas fa-eye fl-tip fl-block-has-rules {{data.rulesTypeRow}}" title="<?php _e( 'This row has visibility rules', 'satori-studio' ); ?>: {{data.rulesTextRow}}"></i>
		<# } #>
	</div>
</script>
<!-- #tmpl-fl-row-overlay -->
...
<script type="text/html" id="tmpl-fl-col-overlay">
	<div class="fl-col-overlay fl-block-overlay<# if ( data.global ) { #> fl-block-overlay-global<# } #>">
		<div class="fl-block-overlay-header">
			<div class="fl-block-overlay-actions">
				...
				<# } else { #>
					...
					<# if ( 'column' !== FLBuilderConfig.userTemplateType && ! FLBuilderConfig.simpleUi ) { #>
						<span class="fl-builder-has-submenu fl-builder-submenu-hover">
							...
							<ul class="fl-builder-submenu fl-block-move-menu">
								<li>
									<a class="fl-builder-submenu-link fl-block-move-dir fl-block-move-up<# if ( data.isFirst ) { #> fl-builder-submenu-disabled<# } #>" href="javascript:void(0);">
										<?php _e( 'Move Left', 'satori-studio' ); ?>
									</a>
								</li>
								<li>
									<a class="fl-builder-submenu-link fl-block-move-dir fl-block-move-down<# if ( data.isLast ) { #> fl-builder-submenu-disabled<# } #>" href="javascript:void(0);">
										<?php _e( 'Move Right', 'satori-studio' ); ?>
									</a>
								</li>
							</ul>
						</span>
					...
					<span class="fl-builder-has-submenu fl-builder-submenu-hover">
						<span class="fl-block-settings fl-tip" title="<?php _e( 'Column Settings', 'satori-studio' ); ?><# if ( data.nodeLabel && ! FLBuilderConfig.node_labels_disabled ) { #>{{FLBuilderConfig.node_labels_separator}}{{data.nodeLabel}}<# } #>">
							<svg width="16" height="16" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
								<path fill="currentColor" d="M352 320c88.4 0 160-71.6 160-160c0-15.3-2.2-30.1-6.2-44.2c-3.1-10.8-16.4-13.2-24.3-5.3l-76.8 76.8c-3 3-7.1 4.7-11.3 4.7H336c-8.8 0-16-7.2-16-16V118.6c0-4.2 1.7-8.3 4.7-11.3l76.8-76.8c7.9-7.9 5.4-21.2-5.3-24.3C382.1 2.2 367.3 0 352 0C263.6 0 192 71.6 192 160c0 19.1 3.4 37.5 9.5 54.5L19.9 396.1C7.2 408.8 0 426.1 0 444.1C0 481.6 30.4 512 67.9 512c18 0 35.3-7.2 48-19.9L297.5 310.5c17 6.2 35.4 9.5 54.5 9.5zM80 408a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/>
							</svg>
						</span>
						<?php if ( ! $simple_ui ) : ?>
							<# if ( ! data.global || ( data.global && FLBuilderConfig.userTemplateType ) ) { #>
								<ul class="fl-builder-submenu fl-block-col-submenu">
									<li><a class="fl-builder-submenu-link fl-block-settings" href="javascript:void(0);"><?php _e( 'Column Settings', 'satori-studio' ); ?></a></li>
									...
									<# if ( data.rowIsFixedWidth ) { #>
										<li><a class="fl-builder-submenu-link fl-block-row-reset" href="javascript:void(0);"><?php _e( 'Reset Row Width', 'satori-studio' ); ?></a></li>
									<# } #>
									<li><a class="fl-builder-submenu-link fl-col-quick-copy" href="javascript:void(0);"><?php _e( 'Copy Column Settings', 'satori-studio' ); ?></a></li>
									<li><a class="fl-builder-submenu-link fl-col-quick-paste <# if ( 'column' === FLBuilderSettingsCopyPaste._getClipboardType() ) { #>fl-quick-paste-active<# } #>" href="javascript:void(0);"><?php _e( 'Paste Column Settings', 'satori-studio' ); ?></a></li>
								</ul>
							<# } #>
						<?php endif; ?>
					</span>
					...
					<?php if ( ! $simple_ui ) : ?>
						<# if ( ! data.isRootCol ) { #>
							<# if ( ( ! data.hasParentCol && data.numCols < 12 ) || ( data.hasParentCol && data.numCols < 4 ) ) { #>
								<span class="fl-block-copy fl-block-col-copy fl-tip" title="<?php _e( 'Duplicate', 'satori-studio' ); ?>">
									<svg width="18" height="18" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
										<path fill="currentColor" d="M64 464H288c8.8 0 16-7.2 16-16V384h48v64c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V224c0-35.3 28.7-64 64-64h64v48H64c-8.8 0-16 7.2-16 16V448c0 8.8 7.2 16 16 16zM224 304H448c8.8 0 16-7.2 16-16V64c0-8.8-7.2-16-16-16H224c-8.8 0-16 7.2-16 16V288c0 8.8 7.2 16 16 16zm-64-16V64c0-35.3 28.7-64 64-64H448c35.3 0 64 28.7 64 64V288c0 35.3-28.7 64-64 64H224c-35.3 0-64-28.7-64-64z"/>
									</svg>
								</span>
							...
							<# if ( data.parentMenu ) { #>
								<span class="fl-builder-has-submenu fl-builder-submenu-hover">
									<span class="fl-block-select-parent fl-tip" title="<?php _e( 'Select Parent', 'satori-studio' ); ?>">
											...
											<li class="fl-builder-has-submenu">
												<a href="javascript:void(0);" data-target-node="{{data.parentMenu[i].node}}" class="fl-builder-submenu-link">
													<span style="margin-left:{{margin}}px;">
														...
														<svg class="fl-caret-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" width="12px" height="12px">
												...
												<ul class="fl-builder-submenu">
													<li>
														<a class="fl-builder-submenu-link fl-block-settings" data-target-node="{{data.parentMenu[i].node}}" href="javascript:void(0);">
															...
															<?php printf( __( '%s Settings', 'satori-studio' ), '{{data.parentMenu[i].name}}' ); ?>
														</a>
													</li>
													<li>
													...
													<li>
														<a class="fl-builder-submenu-link fl-{{data.parentMenu[i].type}}-quick-copy" data-target-node="{{data.parentMenu[i].node}}" href="javascript:void(0);">
															<?php /* translators: %s: Node type */ ?>
															<?php printf( __( 'Copy %s Settings', 'satori-studio' ), '{{data.parentMenu[i].name}}' ); ?>
														</a>
													</li>
													<#
													...
													<li>
														<a class="fl-builder-submenu-link fl-{{data.parentMenu[i].type}}-quick-paste <# if ( pasteActive ) { #>fl-quick-paste-active<# } #>" data-target-node="{{data.parentMenu[i].node}}" href="javascript:void(0);">
															<?php /* translators: %s: Node type */ ?>
															<?php printf( __( 'Paste %s Settings', 'satori-studio' ), '{{data.parentMenu[i].name}}' ); ?>
														</a>
													</li>
												</ul>
											</li>
		...
		<# if ( data.hasRules ) { #>
			<i class="fas fa-eye fl-tip fl-block-has-rules" title="<?php _e( 'This column has visibility rules.', 'satori-studio' ); ?>"></i>
		<# } #>
...
<script type="text/html" id="tmpl-fl-module-overlay">
	<div class="fl-module-overlay fl-block-overlay<# if ( data.global ) { #> fl-block-overlay-global<# } #>">
			...
			<div class="fl-block-overlay-actions">
				...
				<# } else { #>
								...
								<li>
									<a class="fl-builder-submenu-link fl-block-move-dir fl-block-move-up<# if ( data.isFirst ) { #> fl-builder-submenu-disabled<# } #>" href="javascript:void(0);">
										...
										<# } else if ( 'layered' === data.layoutDirection ) { #>
											<?php _e( 'Move Back', 'satori-studio' ); ?>
										<# } else { #>
											<?php _e( 'Move Left', 'satori-studio' ); ?>
										<# } #>
									</a>
								...
								<li>
									<a class="fl-builder-submenu-link fl-block-move-dir fl-block-move-down<# if ( data.isLast ) { #> fl-builder-submenu-disabled<# } #>" href="javascript:void(0);">
										<# if ( 'vertical' === data.layoutDirection ) { #>
											<?php _e( 'Move Down', 'satori-studio' ); ?>
										<# } else if ( 'layered' === data.layoutDirection ) { #>
											<?php _e( 'Move Forward', 'satori-studio' ); ?>
										<# } else { #>
											<?php _e( 'Move Right', 'satori-studio' ); ?>
										<# } #>
									</a>
					...
					<span class="fl-builder-has-submenu fl-builder-submenu-hover">
						...
						<span class="fl-block-settings fl-tip" title="<?php printf( __( '%s Settings', 'satori-studio' ), '{{data.moduleName}}' ); ?><# if ( data.nodeLabel && ! FLBuilderConfig.node_labels_disabled ) { #>{{FLBuilderConfig.node_labels_separator}}{{data.nodeLabel}}<# } #>">
							<svg width="16" height="16" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
								<path fill="currentColor" d="M352 320c88.4 0 160-71.6 160-160c0-15.3-2.2-30.1-6.2-44.2c-3.1-10.8-16.4-13.2-24.3-5.3l-76.8 76.8c-3 3-7.1 4.7-11.3 4.7H336c-8.8 0-16-7.2-16-16V118.6c0-4.2 1.7-8.3 4.7-11.3l76.8-76.8c7.9-7.9 5.4-21.2-5.3-24.3C382.1 2.2 367.3 0 352 0C263.6 0 192 71.6 192 160c0 19.1 3.4 37.5 9.5 54.5L19.9 396.1C7.2 408.8 0 426.1 0 444.1C0 481.6 30.4 512 67.9 512c18 0 35.3-7.2 48-19.9L297.5 310.5c17 6.2 35.4 9.5 54.5 9.5zM80 408a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/>
							</svg>
						</span>
						<ul class="fl-builder-submenu">
							<?php /* translators: %s: module name */ ?>
							<li><a class="fl-builder-submenu-link fl-block-settings" href="javascript:void(0);"><?php printf( __( '%s Settings', 'satori-studio' ), '{{data.moduleName}}' ); ?></a></li>
							<?php /* translators: %s: module name */ ?>
							<li><a class="fl-builder-submenu-link fl-module-quick-copy" href="javascript:void(0);"><?php printf( __( 'Copy %s Settings', 'satori-studio' ), '{{data.moduleName}}' ); ?></a></li>
							<?php /* translators: %s: module name */ ?>
							<li><a class="fl-builder-submenu-link fl-module-quick-paste <# if ( data.moduleType === FLBuilderSettingsCopyPaste._getClipboardType() ) { #>fl-quick-paste-active<# } #>" href="javascript:void(0);"><?php printf( __( 'Paste %s Settings', 'satori-studio' ), '{{data.moduleName}}' ); ?></a></li>
						</ul>
					</span>
		...
		<# if ( data.colHasRules ) { #>
			<i class="fas fa-eye fl-tip fl-block-has-rules {{data.rulesTypeCol}}" title="<?php _e( 'This column has visibility rules', 'satori-studio' ); ?>: {{data.rulesTextCol}}"></i>
		<# } else if ( data.hasRules ) { #>
			<i class="fas fa-eye fl-tip fl-block-has-rules {{data.rulesTypeModule}}" title="<?php _e( 'This module has visibility rules', 'satori-studio' ); ?>: {{data.rulesTextModule}}"></i>
		<# } #>
...
<script type="text/html" id="tmpl-fl-overlay-overflow-menu">
	<span class="fl-builder-has-submenu fl-builder-submenu-hover">
		<i class="fl-block-overflow-menu fas fa-bars fl-tip" title="<?php _e( 'More', 'satori-studio' ); ?>"></i>
		<ul class="fl-builder-submenu">
			<# for( var i = 0; i < data.length; i++ ) { #>
				<# if ( 'submenu' == data[ i ].type ) { #>
					<li class="fl-builder-has-submenu">
						<a href="javascript:void(0);" class="{{data[ i ].className}}">
							{{data[ i ].label}}
							<svg class="fl-caret-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" width="12px" height="12px">
