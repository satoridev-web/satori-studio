...
<div class="fl-multiple-photos-field fl-builder-custom-field<# if ( '' === data.value ) { #> fl-multiple-photos-empty<# } #><# if ( data.field.className ) { #> {{data.field.className}}<# } #>">
	...
	<a class="fl-multiple-photos-select" href="javascript:void(0);" onclick="return false;"><?php _e( 'Create Gallery', 'satori-studio' ); ?></a>
	<a class="fl-multiple-photos-edit" href="javascript:void(0);" onclick="return false;"><?php _e( 'Edit Gallery', 'satori-studio' ); ?></a>
	<a class="fl-multiple-photos-add" href="javascript:void(0);" onclick="return false;"><?php _e( 'Add Photos', 'satori-studio' ); ?></a>
