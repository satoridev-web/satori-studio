...
echo 'FLBuilderStrings             = ' . FLBuilderUtils::json_encode( apply_filters('fl_builder_ui_js_strings', array(
	...
	'i18n'                           => array(
		'Grid'                                         => esc_attr__( 'Grid', 'fl-builder' ),
		'Flex'                                         => esc_attr__( 'Flex', 'fl-builder' ),
		'Flex Row'                                     => esc_attr__( 'Flex Row', 'fl-builder' ),
		'Flex Column'                                  => esc_attr__( 'Flex Column', 'fl-builder' ),
		'Layered'                                      => esc_attr__( 'Layered', 'fl-builder' ),
		'Outline'                                      => esc_attr__( 'Outline', 'fl-builder' ),
		'Query Monitor'                                => esc_attr__( 'Query Monitor', 'fl-builder' ),
		'No content found'                             => esc_attr__( 'No content found', 'fl-builder' ),
		'Add something'                                => esc_attr__( 'Add Something', 'fl-builder' ),
		'to get started'                               => esc_attr__( 'to get started', 'fl-builder' ),
		'Click + to add layers'                        => esc_attr__( 'Click + to add layers', 'fl-builder' ),
		'sRGB'                                         => esc_attr__( 'sRGB', 'fl-builder' ),
		'Presets'                                      => esc_attr__( 'Presets', 'fl-builder' ),
		'Linear'                                       => esc_attr__( 'Linear', 'fl-builder' ),
		'Linear sRGB'                                  => esc_attr__( 'Linear sRGB', 'fl-builder' ),
		'Radial'                                       => esc_attr__( 'Radial', 'fl-builder' ),
		'Conic'                                        => esc_attr__( 'Conic', 'fl-builder' ),
		'OKLAB'                                        => esc_attr__( 'OKLAB', 'fl-builder' ),
		'OKLCH'                                        => esc_attr__( 'OKLCH', 'fl-builder' ),
		'Text'                                         => esc_attr__( 'Text', 'fl-builder' ),
		'Color'                                        => esc_attr__( 'Color', 'fl-builder' ),
		'Gradient'                                     => esc_attr__( 'Gradient', 'fl-builder' ),
		'Photo'                                        => esc_attr__( 'Photo', 'fl-builder' ),
		'Rings'                                        => esc_attr__( 'Rings', 'fl-builder' ),
		'Stripes'                                      => esc_attr__( 'Stripes', 'fl-builder' ),
		'Sunburst'                                     => esc_attr__( 'Sunburst', 'fl-builder' ),
		'Dots'                                         => esc_attr__( 'Dots', 'fl-builder' ),
		'Triangles'                                    => esc_attr__( 'Triangles', 'fl-builder' ),
		'Alpha'                                        => esc_attr__( 'Alpha', 'fl-builder' ),
		'Hue'                                          => esc_attr__( 'Hue', 'fl-builder' ),
		'Clear'                                        => esc_attr__( 'Clear', 'fl-builder' ),
		'Search'                                       => esc_attr__( 'Search', 'fl-builder' ),
		'Mix'                                          => esc_attr__( 'Mix', 'fl-builder' ),
		'Unnamed Pattern'                              => esc_attr__( 'Unnamed Pattern', 'fl-builder' ),
		'Pattern'                                      => esc_attr__( 'Pattern', 'fl-builder' ),
		'Color Space'                                  => esc_attr__( 'Color Space', 'fl-builder' ),
		'Saved Colors'                                 => esc_attr__( 'Saved Colors', 'fl-builder' ),
		'Mix two color values to create a new color'   => esc_attr__( 'Mix two color values to create a new color', 'fl-builder' ),
		'Are you sure you want to delete this preset?' => esc_attr__( 'Are you sure you want to delete this preset?', 'fl-builder' ),
		'Once you choose a color you can save it as a preset by clicking the + button above.' => esc_attr__( 'Once you choose a color you can save it as a preset by clicking the + button above.', 'fl-builder' ),
	),
) ) ) . ';';
