...
<p><?php _e( 'The following downloads are currently available for remote update with the subscription(s) associated with this license.', 'satori-studio' ); ?></p>
...
<?php if ( ! $themer ) : ?>
        ...
        <h4>
                <strong><?php _e( 'Beaver Themer (legacy)', 'satori-studio' ); ?></strong> - <a target="_blank" href="
                <?php
