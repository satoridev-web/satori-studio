# SATORI Studio Licensing Notes — Beaver Builder Fork (Text-Only Pass)

## Origin and Lineage
- **Upstream Project:** Beaver Builder Lite by The Beaver Builder Team (FastLine Media LLC).
- **Fork Status:** SATORI Studio is a fork that reuses and modifies portions of Beaver Builder Lite under the terms of the GPL v2 or later license.
- **License Reference:** See `license.txt` for the full GPL v2+ text.

## Attribution and Obligations
- The original Beaver Builder Lite copyright and notices must be preserved.
- All modifications and new code shipped with SATORI Studio continue to be licensed under GPL v2 or later (or another GPL v2+ compatible license where applicable).
