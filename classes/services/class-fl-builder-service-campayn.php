...
final class FLBuilderServiceCampayn extends FLBuilderService {
	...
	public function render_connect_settings() {
		...
		FLBuilder::render_settings_field( 'api_host', array(
			...
			'help'      => __( 'The host you chose when you signed up for your account. Check your welcome email if you forgot it. Please enter it without the initial http:// (for example: demo.campayn.com).', 'satori-studio' ),
			'preview'   => array(
				'type' => 'none',
			),
		));
